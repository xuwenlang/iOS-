...
@interface XWLCellAnimationController ()

@property (strong, nonatomic) NSMutableSet *showIndexes;

@end

@implementation XWLCellAnimationController
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"KYCell"];
...
- (void)setType:(XWLCellAnimationType)type {
    _type = type;
...
- (void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (_type) {
        ...
        case XWLCellAnimationTypeTwo:
        {
            ...
            break;
        case XWLCellAnimationTypeThree:
        {
            //动画3：
            if (![self.showIndexes containsObject:indexPath]) {
                [self.showIndexes addObject:indexPath];
